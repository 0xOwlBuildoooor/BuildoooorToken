...
async function main(){
    console.log("For the Culture");
    const myKeypair = loadWalletKey("7brw7LLvorNm8ew2CMCMnt8P2gTGh7KucHk2ssPfa466.json");
    const mint = new web3.PublicKey("E1NmcskGm2syS97NhqJbTjnZsWQWuvSTBkmzoFyjhF4s");
    ...
    const ourMetadata = { // TODO change those values!
        name: "Buildoooor", 
        symbol: "BLDR",
        uri: "https://github.com/0xOwlBuildoooor/BuildoooorToken/blob/8d28a0be66aa292a0ff9f3eb138a2fa4a8a2e92b/TheBuildoooor369.png",
    }
    const onChainData = {
        ...ourMetadata,
        // we don't need that
